<script lang="ts">
	...
	let picks: (Pick & { User: User | null, Character: AnimeCharacter; collab: Collab;})[] = [];
	...
	function getTypedPick(pick: Pick & { User: User | null; Character: AnimeCharacter; collab: Collab }): Pick & { User: User; Character: AnimeCharacter } {
		return {
			...pick,
			User: pick.User!,
