...
<div id="privacy">
	...
	<p>
		This privacy notice for Endless Mirage (<strong>'we'</strong>, <strong>'us'</strong>, or
		<strong>'our'</strong>), describes how and why we might collect, store, use, and/or share (<strong
			>'process'</strong
		>) your information when you use our services (<strong>'services'</strong>), such as when you:
	</p>
	<ul>
		<li>
			Visit our website at endlessmirage.net, or any website of ours that links to this privacy
			notice
		</li>
	...
	<p>
		...
		our services. If you still have any questions or concerns, please contact us through one of the contact
		methods provided at the bottom of this document.
	</p>
	...
	<p class="sub">
		...
		services, we may process personal information depending on how you interact with Endless Mirage
		and the services, the choices you make, and the products and features you use.
		<a href="#personalinfo">Click here to learn more. </a>
	</p>
	<p class="sub">
	...
	<p class="sub">
		...
		<a href="#infouse">Click here to learn more. </a>
	</p>
	<p class="sub">
		...
		<a href="#whoshare">Click here to learn more. </a>
	</p>
	<p class="sub">
		<strong>How do we keep your information safe?</strong> We have an appropriate level of security
		in place for our servers, and use processes to ensure access to our servers is restricted.
		...
		other unauthorised third parties will not be able to defeat our security and improperly collect,
		access, steal, or modify your information. <a href="#infosafe">Click here to learn more. </a>
	</p>
	<p class="sub">
		<strong>What are your rights?</strong> Depending on where you are located geographically, the
		applicable privacy law may mean you have certain rights regarding your personal information. We
		aim to provide everyone with full access to their personal information, regardless of difference
		in geographical laws.
		<a href="#privacyrights">Click here to learn more. </a>
	</p>
	<p class="sub">
		<strong>How do you exercise your rights?</strong> The easiest way to exercise your rights is by
		managing your profile through the website, or deleting your account at the following link:
		<a href="{base}/profile/delete" target="_blank" rel="noreferrer"
			>https://endlessmirage.net/profile/delete
		</a>, or by contacting us. We will consider and act upon any request in accordance with
		applicable data protection laws.
	</p>
	<p class="sub">
		Want to learn more about what Endless Mirage does with any information we collect? <a
			href="#toc"
	...
	<p class="section" id="personalinfo"><strong>Personal information you disclose to us</strong></p>
	<p class="sub">
	...
	<p class="sub">
		...
		service, express an interest in obtaining information about us or our service, when you
		participate in activities on the service, or otherwise when you contact us.
	</p>
	<p>
		<strong>Personal information provided by you.</strong> The personal information that we collect depends
		on the context of your interactions with us and the service, the choices you make, and the products
	...
	<p class="sub">
		<strong>Social media/game login data.</strong> We may provide you with the option to register
		with us using your existing social media/game account details, like your Discord, osu!, or other
		accounts. If you choose to register in this way, or connect any accounts, we will collect the
	...
	<p class="section"><strong>Information automatically collected</strong></p>
	<p class="sub">
		<strong><em>In Short: </em></strong><em>
			Some information &mdash; such as your Internet Protocol (IP) address and/or browser and device
			characteristics &mdash; is collected automatically when you visit our service.
		</em>
	</p>
	<p class="sub">
		...
		location, information about how and when you use our service, and other technical information.
		This information is primarily needed to maintain the security and operation of our service, and
		for our internal analytics and reporting purposes.
	</p>
	<p class="sub">
		Like many websites, we also collect information through cookies and similar technologies. You
		can find out more about this in our cookie policy: <a
			href="{base}/cookies"
			target="_blank"
			rel="noreferrer"
			>https://endlessmirage.net/cookies
		</a>.
	</p>
	...
	<ul>
		<li>
			...
			information our servers automatically collect when you access or use our service and which we record
			in log files. Depending on how you interact with us, this log data may include your IP address,
			device information, browser type, and settings and information about your activity in the service
		...
		<li>
			...
			or other device you use to access the service. Depending on the device used, this device data may
		...
		<li>
			...
			settings of the device you use to access the service. For example, we may use GPS and other technologies
			to collect geolocation data that tells us your current location (based on your IP address). You
			can opt out of allowing us to collect this information either by refusing access to the information
			or by disabling your location setting on your device. If you choose to opt out, you may still use
			the service as usual. Location data is not critical, and only provides insight into the usage of
			the service.
		</li>
	</ul>
	...
	<p class="sub">
		<strong><em>In Short: </em></strong><em
			>We process your information to provide, improve, and administer our service, communicate with
	...
	<ul>
		...
		<li>
			<strong>To protect our service.</strong> We may process your information as part of our efforts
			to keep our service safe and secure, including fraud monitoring and prevention.
		</li>
		<li>
			<strong>To identify usage trends.</strong> We may process information about how you use our service
	...
	<p>
		<em
			><strong><u>If you are located in the EU or UK, this section applies to you. </u></strong></em
		>
	</p>
	<p>
	...
	<ul>
		<li>
			...
			consent at any time. <a href="#withdrawconsent">Click here to learn more. </a>
		</li>
		<li>
			<strong>Legitimate Interests.</strong> We may process your information when we believe it is
			reasonably necessary to achieve our legitimate interests and those interests do not outweigh
			...
			<ul>
				<li>Analyse how our service is used so we can improve it to engage and retain users</li>
				<li>Diagnose problems and/or prevent fraudulent activities</li>
				<li>Understand how our users use our service so we can improve user experience</li>
			</ul>
		</li>
		<li>
			...
			information as evidence in litigation in which we are involved.<br />
		</li>
		<li>
	...
	<p class="sub">
		...
		can be inferred (i.e. implied consent). You can withdraw your consent at any time. <a
	...
	<p>
		...
		your data with third-party vendors, service providers, contractors, or agents ('<strong
			>third parties</strong
		>') who perform services for us or on our behalf and require access to such information to do
		that work. The third parties we may share personal information with are as follows:
	</p>
	<ul>
		<li>
			Discord
	...
	<p>
		...
		refuse certain cookies is set out in our cookie policy: <a
			href="{base}/cookies"
			target="_blank"
			rel="noreferrer"
			>https://endlessmirage.net/cookies
	...
	<p class="sub">
		<strong><em>In Short: </em></strong><em
			>If you choose to register or log in to our service using a social media/game account, we may
			have access to certain information about you.
		</em>
	</p>
	<p class="sub">
		Our service offers you the ability to register and log in using your third-party social
		media/game account details (like your Discord or osu! accounts). Where you choose to do this, we
		will receive certain profile information about you from your social media/game provider. The
		profile information we receive may vary depending on the social media/game provider concerned,
		but will often include your (user)name, email address, friends list, and profile picture, as
		well as other information you choose to make public on such a social media/game platform.
	</p>
	<p class="sub">
		We will use the information we receive only for the purposes that are described in this privacy
		notice or that are otherwise made clear to you on the relevant service. Please note that we do
		not control, and are not responsible for, other uses of your personal information by your
		third-party social media/game provider. We recommend that you review their privacy notice to
	...
	<p class="sub">
		When we have no ongoing legitimate need to process your personal information, we will either
	...
	<p class="sub">
		...
		to and from our service is at your own risk. You should only access the service within a secure
		environment.
	</p>
	...
	<p class="sub" id="withdrawconsent">
		<strong
			><u
				...
				any time by deleting your account.</u
			></strong
		>
	</p>
	<p class="section">
	...
	<p class="sub">
		<strong
			><u
				...
				features or services of our service. For further information, please see our cookie policy:
				<a href="{base}/cookies" target="_blank" rel="noreferrer"
					>https://endlessmirage.net/cookies.
				</a></u
			></strong
		>
	...
	<p class="sub">
		If you have questions or comments about your privacy rights, you may contact us through the
		information provided at the bottom of the document.
	</p>
	...
	<p class="sub">
		...
		service, you have the right to request removal of unwanted data that you publicly post on the
		service. To request removal of such data, please contact us using the contact information
		provided below and include the email address associated with your account and a statement that
		you reside in California. We will make sure the data is not publicly displayed on the service,
	...
	<p>You may contact us through the following platforms:</p>
	<ul>
		<li>Discord: Kabouter#1337</li>
		<li>Email: lesley.vanderlee@repose.software</li>
	</ul>
	...
	<div>
		...
		that information, or delete it. To review, update, or delete your personal information, please
		visit: <a href="{base}/profile" target="_blank" rel="noreferrer"
			>https://endlessmirage.net/profile</a
		>.
	</div>
</div>
